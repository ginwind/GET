...
from utils.data_utils import load_regression_le, load_kg_regression_le
...
ap.add_argument('--dataset_path', type=str, default="./dataset/le/splits")
...
if __name__ == "__main__":
    ...
    if peft == "GET":
        train_loader, test_loader, val_loader, words, relations = load_kg_regression_le(dataset_path=args.dataset_path, tokenizer=tokenizer, dataset_name=dataset_name, batch_size=args.batch_size)
    else:
        train_loader, test_loader, val_loader, words, relations = load_regression_le(dataset_path=args.dataset_path, tokenizer=tokenizer, dataset_name=dataset_name, batch_size=args.batch_size)
    ...
    trainer.train_le(train_loader, test_loader, val_loader)